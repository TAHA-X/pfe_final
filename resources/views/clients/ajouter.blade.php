...
@section("body")
   @if(count($projets)>0)
    <form  action="{{ Route('clients.store') }}" method="post">
        ...
        <div class="mt-2">
            ...
            <input type="text"  value="{{ old('prénom') }}" class="form-control @error('prénom') is-invalid  @enderror" id="prénom" name="prénom"/>
        </div>
        @error("prénom")
        ...
        <div class="mt-2">
            ...
            <input type="text" value="{{ old('nom') }}" id="nom" class="form-control @error('nom') is-invalid  @enderror" name="nom"/>
        </div>
        @error("nom")
        <span class="text-danger">{{ $message }}</span>
        @enderror
        ...
        <div class="mt-2">
            ...
            <input type="number" value="{{ old('phone') }}" id="phone" class="form-control @error('phone') is-invalid  @enderror" name="phone"/>
        </div>
        @error("phone")
        <span class="text-danger">{{ $message }}</span>
        @enderror
        ...
        <div class="mt-2">
            ...
            <input value="homme" checked id="homme" name="sex" type="radio"> <label class="form-label" for="homme">homme</label> <br/>
            <input value="femme" id="femme" name="sex" type="radio"> <label class="form-label" for="femme">femme</label>
        </div>
   ...
   @else
      <div class="alert alert-danger">vous devez avoir une residence pour ajouter un client</div>
   @endif
